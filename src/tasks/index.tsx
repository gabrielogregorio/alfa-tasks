...
export const TasksPage = (): ReactElement => {
  ...
  return (
    <div className="w-full flex-1 px-[1rem]">
      {errorOnPastToClipboard ? (
        <div className="top-0 left-0 absolute z-50 w-screen h-screen flex items-center justify-center animate-fadeInDrop">
          <div className="bg-textColor/70 text-textColor shadow-default px-[1rem] py-[1rem] rounded-[3px] border-2 border-textColor animate-fadeIn">
      ...
      <div className="flex-1">
        <h1 className="text-center mt-[8rem] text-textColor font-bold text-2xl">MY TASKS</h1>

        <div className="mt-[5rem] overflow-hidden flex items-center justify-center">
          <Tasks />
        </div>

        <div className="w-full flex items-center justify-center mt-[10rem]">
          <div className='flex flex-col max-w-[620px] w-full"'>
            <Button content="DOWNLOAD BACKUP" onClick={() => handleDownloadLocalstorage()} />
            <Button content="COPIAR BACKUP" onClick={() => handleCopyToClipboard()} />
            <Button
